...
$(function () {
  ...
  if($('.mqc_table').length > 0){
    ...
    // Enable tablesorter on MultiReport tables
    ...
    // Make rows in MultiReport tables sortable
    ...
    // Sort MultiReport tables by highlight
    ...
    $(document).on('mqc_hidesamples', function(e, f_texts, regex_mode){
      ...
      // Hide rows in MultiReport tables
      $(".mqc_table tbody th").each(function(){
        var match = false;
...
// Reorder columns in MultiReport tables.
