...
$(function () {
  ...
  $('.hc-plot-handle').on('mousedown', function(e){
    ...
    $(document).on('mouseup', function(e){
      ...
      $(wrapper.parent().find('.hc-plot, .beeswarm-plot')).trigger('mqc_plotresize', pY);
    });
  ...
  $('.hc-plot, .beeswarm-plot').on('mqc_plotresize', function(me, pY){
    var wrapper = $(this).parent();
    var startHeight = wrapper.height();
    ...
    // Resize plotly plot when user drag the .hc-plot-handle bar.
    if($(this).hasClass('js-plotly-plot')) {
      const id = $(this).attr('id');
      console.log('Relayout: ', id, me, pY);
      Plotly.relayout(id, {
        height: startHeight + (me.pageY - pY)
      })
    }
  });
